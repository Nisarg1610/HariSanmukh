                ...
                {unassignedMembers.map((member) => (
                  <button
                    ...
                    style={{
                      ...
                      color: selectedMemberId === member.id ? 'white' : 'var(--text-2)',
            ...
            return (
              <div
                ...
                style={{
                  ...
                  backgroundColor: canAssign && !alreadyAssignedToDay && dayAssignments.length === 0 ? 'var(--accent-bg)' : canAssign && !alreadyAssignedToDay ? 'rgba(0,0,0,0.02)' : 'transparent',
                }}
              >
                <div className="flex items-center gap-3">
                  ...
                  {dayAssignments.length === 0 ? (
                    ...
                    <>
                      ...
                      {canAssign && !alreadyAssignedToDay && (
                        <span className="text-[12px] self-center ml-1 font-extrabold px-2 rounded-md hover:animate-pulse" style={{ color: 'var(--accent)' }}>
                          + ADD
                        </span>
                      )}
                    </>
